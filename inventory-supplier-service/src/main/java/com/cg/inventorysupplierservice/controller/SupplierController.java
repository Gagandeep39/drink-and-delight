...
public class SupplierController {
	...
	@RequestMapping(value="/addwarehouse", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, 
	...
	public Warehouse addWarehouse(@RequestBody Warehouse wh) throws Exception
	{
		...
		else throw new Exception("Parameter value cannot be null");
		
		
	}
	
	@RequestMapping(value="/fetchallwarehouses", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value="/adddistributor", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value="/fetchalldistributors", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value="/addsupplier", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value="/fetchallsuppliers", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
