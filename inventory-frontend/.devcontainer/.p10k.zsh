# Generated by Powerlevel10k configuration wizard on 2020-12-05 at 07:49 UTC.
...
# left frame, light-ornaments, compact, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=54
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=7
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=57
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=7
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=55
